...
const AboutMe = ({ closebtn }) => {
  const skills = [
    ...
    "#tailwind", "#git", "#github", "#PostgreSQL", "SQL", "Next.js"
  ];
      ...
      <div className="pop-up">
        <div className="flex-container">
          ...
          <div className="right-box">
            ...
            <p className="slogan slide-in-right">
        ...
        <div className="mern-stack">
          <h2 className="text-xl font-semibold text-[#1788ae] mb-2 glow-text">MERN STACK</h2>
          <div className="stack-icons">
            <div className="flex gap-4">
              <div className="flex flex-col items-center icon-container">
                <div className="bg-green-600 text-white p-3 rounded-full shadow-md mb-2 hover:scale-110 transition-transform duration-300">
              ...
              <div className="flex flex-col items-center icon-container">
                <div className="bg-gray-800 text-white p-3 rounded-full shadow-md mb-2 hover:scale-110 transition-transform duration-300">
                ...
                <h2 className="text-[#FFFFFF] text-lg font-bold">E</h2>
              </div>

              <div className="flex flex-col items-center icon-container">
                <div className="bg-[#1788ae] text-white p-3 rounded-full shadow-md mb-2 hover:scale-110 transition-transform duration-300">
              ...
              <div className="flex flex-col items-center icon-container">
                <div className="bg-[#ffc107] text-white p-3 rounded-full shadow-md mb-2 hover:scale-110 transition-transform duration-300">
