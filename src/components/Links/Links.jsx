  ...
  return (
    <div className="sticky top-0 z-50">
      ...
      <div className="relative ">
        {/* More compact container with reduced padding */}
        <div className="backdrop-blur-md bg-black/50 p-1 rounded-lg border border-gray-700/50 shadow-xl">
            ...
            {[
              ...
              <li key={index} className="relative">
                <a 
                  ...
                  className="block p-1 group"  // Reduced padding here
                >
                  {/* Smaller icon container */}
                  <div className={`
                    relative z-10 p-2 rounded-full  // Reduced padding
                    bg-gray-800/80 border border-gray-700
                    transition-all duration-200
                    ${activeIcon === index ? 'scale-110 bg-gray-700/80' : 'scale-100'}
                    ${iconStyles[index].hoverGlow}
                  `}>
                    <div className={`
                      transition-all duration-300
                      ${iconStyles[index].color}
                    `}>
                      {item.icon}
                    </div>
                  </div>
                  
                  {/* Smaller tooltip positioned closer */}
                  <div className={`
                    ...
                    whitespace-nowrap text-[0.7rem]  // Smaller text
                  `}>
                    {item.name}
                  </div>
                </a>
