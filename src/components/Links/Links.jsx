...
function Links({ darkMode = true, isMobilePopup = false }) {
  ...
  const iconStyles = darkMode ? [
    { 
      ...
      hoverGlow: 'hover:drop-shadow-[0_0_8px_rgba(255,255,255,0.8)]',
      bg: 'bg-gray-800/90'
    },
    { 
      name: 'LinkedIn', 
      color: 'text-blue-400 hover:text-blue-300', 
      hoverGlow: 'hover:drop-shadow-[0_0_8px_rgba(10,102,194,0.6)]',
      bg: 'bg-blue-900/20'
    },
    { 
      name: 'Twitter', 
      color: 'text-sky-400 hover:text-sky-300', 
      hoverGlow: 'hover:drop-shadow-[0_0_8px_rgba(29,161,242,0.6)]',
      bg: 'bg-sky-900/20'
    },
    { 
      name: 'Email', 
      color: 'text-red-400 hover:text-red-300', 
      hoverGlow: 'hover:drop-shadow-[0_0_8px_rgba(234,67,53,0.6)]',
      bg: 'bg-red-900/20'
    }
  ] : [
    { 
      ...
      hoverGlow: 'hover:drop-shadow-[0_0_8px_rgba(0,0,0,0.2)]',
      bg: 'bg-gray-100/90'
    },
    { 
      name: 'LinkedIn', 
      color: 'text-blue-600 hover:text-blue-800', 
      hoverGlow: 'hover:drop-shadow-[0_0_8px_rgba(10,102,194,0.3)]',
      bg: 'bg-blue-100/50'
    },
    { 
      name: 'Twitter', 
      color: 'text-sky-500 hover:text-sky-700', 
      hoverGlow: 'hover:drop-shadow-[0_0_8px_rgba(29,161,242,0.3)]',
      bg: 'bg-sky-100/50'
    },
    // { 
    //   name: 'Email', 
    //   color: 'text-red-500 hover:text-red-700', 
    //   hoverGlow: 'hover:drop-shadow-[0_0_8px_rgba(234,67,53,0.3)]',
    //   bg: 'bg-red-100/50'
    // }
  ];
  ...
  return (
    <div className="z-50 w-full">
      <div className="relative mx-auto w-full sm:max-w-2xl">
        ...
        >
          <motion.ul 
            className={`flex relative p-0 ${darkMode ? 'bg-gray-900/80' : 'bg-white/45'} rounded-full justify-center items-center gap-2 p-1 
              ${!isMobilePopup ? 'flex-col md:flex-row space-y-2 md:space-y-0 md:space-x-2' : 'flex-row space-x-2'}`}
            layout
          >
                    ...
                    {tooltipVisible === index && (
                      <motion.div
                        className={`
                          ...
                          text-xs font-medium ${darkMode ? 'bg-gray-800 text-white' : 'bg-white text-gray-800'} px-2 py-1 rounded
